...
const cargarTabla = () => {
    ...
    datos.map((item) => {
        ...
        const celdas = `<td>${item.gift}</td>
            ...
            <td><img src="/CRUD/media/edit.png" alt="edit-button" onclick="mostrarModal(${item.id})"></td>
            <td><img src="/CRUD/media/delete.png" alt="delete-button" onclick="eliminarGiftCard(${item.id})"></td>  
        `;
